...
public class EditEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras !=null){
            ...
            tanggalKegiatan.setText(eventResponse.getTanggalKegiatan());
            waktuKegiatan.setText(eventResponse.getWaktuKegiatan());
            tempatKegiatan.setText(eventResponse.getTempatKegiatan());
            deskripsiKegiatan.setText(eventResponse.getDeskripsiKegiatan());
        }
...
//        eventModel.setImageKegiatan(imageKegiatan.getText().toString());
        ...
        Call<EventResponse> eventResponseCall = BaseUrl.getUserService().editEvent("Bearer " + sharedPreferences.getString("token",""), eventResponse.getId(), eventModel);
        eventResponseCall.enqueue(new Callback<EventResponse>() {
            @Override
            public void onResponse(Call<EventResponse> call, Response<EventResponse> response) {

                if(response.isSuccessful()){
                    Toast.makeText(EditEventActivity.this,"Edit Kegiatan Success!", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<EventResponse> call, Throwable t) {
                Toast.makeText(EditEventActivity.this,"Throwable "+t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        });
